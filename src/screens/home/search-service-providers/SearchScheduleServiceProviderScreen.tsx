...
import SearchScheduleSPFunction from './functions/SearchScheduleSP';
...
const SearchScheduleServiceProviderScreen: React.FC<
...
> = ({route}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SearchScheduleSPFunction params={route.params} />
...
export default SearchScheduleServiceProviderScreen;
